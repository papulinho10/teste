  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end">
      ...
      <button
        ...
        className="w-14 h-14 bg-[#22C55E] text-white rounded-full shadow-[0_10px_30px_rgba(34,197,94,0.4)] flex items-center justify-center hover:scale-110 transition-transform"
        aria-label="WhatsApp"
      >
